...
export const listFiles = tool(
  async ({}) => {
    ...
    const response = await axios.get(
      "http://sandbox-service-019e4f86-4278-711e-9955-bc56a2f05965:3000/list-files",
    );
...
export const readFiles = tool(
  async ({ files: [] }) => {
    ...
    const response = await axios.get(
      "http://sandbox-service-019e4f86-4278-711e-9955-bc56a2f05965:3000/read-files?files=" +
        files.join(","),
    );
...
export const updateFiles = tool(
  async ({ files }) => {
    ...
    const response = await axios.patch(
      "http://sandbox-service-019e4f86-4278-711e-9955-bc56a2f05965:3000/update-files",
      {
        updates: files,
      },
    );
